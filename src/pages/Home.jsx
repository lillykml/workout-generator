...
const Home = ({ workout, removeExerciseFromWorkout, generateWorkout, save, rename}) => {
    return(
        <div className='mb-7'>
            ...
            {workout && 
            <>
                 <Workout workout={workout} clickHandler={removeExerciseFromWorkout} className="workout" buttonText={<FontAwesomeIcon icon={faTrash}/>}  rename={rename}/>
